...
#         self._ax_4.text2D(0.15, 1.95, "Pmin")
        ...
        p_cands = self._ax_3.plot(cand[:, 0], cand[:, 1], 'b+',
                                  label="Candidates")
        p_ei = self._ax_3.contour(x, y, ei_values, colors=('green'),
                                  label="Expected Improvement")

        #self._ax_3.legend((p_points, p_cands, p_ei),
        #                  ('Points', 'Candidates', 'Expected Improvement'),
        #                  loc=0)
        self._ax_3.legend()
